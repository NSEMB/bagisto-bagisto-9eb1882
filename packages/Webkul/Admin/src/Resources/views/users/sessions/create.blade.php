            ...
            <div class="flex flex-col min-w-[300px] bg-white dark:bg-gray-900 rounded-md box-shadow">
                ...
                <x-admin::form :action="route('admin.session.store')">
                    ...
                    <div class="flex justify-between items-center p-4">
                        ...
                        <!-- Submit Button -->
                        <button
                            class="px-3.5 py-1.5   rounded-md text-gray-50 font-semibold cursor-pointer"
                            aria-label="{{ trans('admin::app.users.sessions.submit-btn')}}" style="background-color:#eb1070"
                        >
